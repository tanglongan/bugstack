package com.tanglongan.dp14_command.worse;
...
public class WorseXiaoEr {

    private static final Logger logger = LoggerFactory.getLogger(WorseXiaoEr.class);

    private static final Map<Integer, String> cuisineMap = new ConcurrentHashMap<>();
